...
- `contributor-2`: [quotes-bordel-int2](https://github.com/TitanX2B/quotes-Bordel-int2.git)
- `contributor-3`: [quotes-cupif-int2](https://github.com/LeMages/quotes-cupif-int2.git)
